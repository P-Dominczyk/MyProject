from Project import comment_to_check, compute_sentiment, load_revievs, open_database, save_database, remove_punctuations


def test_comment_to_check():
...
def test_load_revievs(tmpdir):
    with tmpdir.as_cwd():
        path =r'C:\Users\pedom\OneDrive\Praktyczny_Python_materialy\MyProject\1_3.txt'
